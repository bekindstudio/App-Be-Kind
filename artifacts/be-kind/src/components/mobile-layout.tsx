...
function BottomNav() {
  ...
  return (
    <nav className="absolute bottom-0 left-0 right-0 bg-white/90 backdrop-blur-xl border-t border-border/30 px-3 pt-1.5 pb-5 shadow-[0_-2px_24px_rgba(0,0,0,0.06)] z-50 flex justify-around items-center">
      {navItems.map((item) => {
