        ...
        {isLoading ? (
          ...
          <div className="flex flex-col gap-4">
            <div className="space-y-3">
              {cart.items.map(item => (
                <div key={item.id} className="flex gap-4 items-center bg-card p-4 rounded-[20px] border border-border/30 shadow-sm">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {item.customizations && <div className="text-xs text-muted-foreground mt-1 line-clamp-1">{item.customizations}</div>}
                  </div>
            ...
            <div className="bg-card rounded-[24px] p-5 border border-border/30 shadow-sm space-y-3">
